...
class CookingTool(Base):
    ...
    storage_location = Column(String, nullable=True)  # Specific location within the location (e.g., "Top shelf", "Drawer 2")
...
class ToolWishlist(Base):
    ...
    name = Column(String, nullable=False)
    description = Column(Text, nullable=True)
    url = Column(String, nullable=True)  # Link to product page
