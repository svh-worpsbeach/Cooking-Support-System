...
struct Localizable {
    static let translations: [String: [String: String]] = [
        "de": [
            ...
            "recipes.times": "Zeiten",
            "recipes.prepTime": "Vorbereitungszeit (H:MM)",
            "recipes.cookTime": "Kochzeit (H:MM)",
        ...
        "en": [
            ...
            "recipes.steps": "Steps",
            "recipes.times": "Times",
            "recipes.prepTime": "Prep Time (H:MM)",
            "recipes.cookTime": "Cook Time (H:MM)",
